#include "D3D11DeviceContextState.h"
#include <stddef.h>

RDCBOOST_NAMESPACE_BEGIN

SD3D11DeviceContextState::SD3D11DeviceContextState()
{
	static_assert(offsetof(SD3D11DeviceContextState, m_VertexShaderState) == 0, 
					"this class can't have virtual functions, or memset will cause error");

	memset(this, 0, sizeof(SD3D11DeviceContextState));
}
...
void SD3D11DeviceContextState::GetFromContext(ID3D11DeviceContext* ctx, UINT* SOOffsets)
{
...
void SD3D11DeviceContextState::SetToContext(ID3D11DeviceContext* ctx) const
{
...
// 		ctx->CSSetUnorderedAccessViews(0, eUAVCount, m_pCSUnorderedAccessViews, NULL);
}
