...
struct SD3D11DeviceContextState
{
	enum {
...
private:
	SD3D11DeviceContextState(const SD3D11DeviceContextState&);
	SD3D11DeviceContextState& operator=(const SD3D11DeviceContextState&);
};
