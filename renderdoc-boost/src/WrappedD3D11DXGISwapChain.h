...
class WrappedD3D11DXGISwapChain : public IDXGISwapChain
{
...
public:
	WrappedD3D11DXGISwapChain(IDXGISwapChain* pReal, WrappedD3D11Device* pWrappedDevice);

	virtual ~WrappedD3D11DXGISwapChain();
